        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="pricing14-text061 thq-heading-2">
                    Pricing plan
                  </h2>
                </Fragment>
              )}
              ...
              <div className="pricing14-price">
                <div className="pricing14-price01">
                  <p>
                    {props.plan1 ?? (
                      <Fragment>
                        <p className="pricing14-text082 thq-body-large">
                          Basic plan
                        </p>
                      </Fragment>
                    )}
                  ...
                  <h3>
                    {props.plan1Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text090 thq-heading-3">
                          Harga Paket 1: Rp 50.000 per briket
                        </h3>
                      </Fragment>
                    )}
                  </h3>
                  <p>
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <p className="pricing14-text066 thq-body-large">
                ...
                <div className="pricing14-list">
                  ...
                  <div className="pricing14-list-item02">
                    ...
                    <span>
                      {props.plan1Feature3 ?? (
                        <Fragment>
                          <span className="pricing14-text069 thq-body-small">
              ...
              <div className="pricing14-price02">
                <div className="pricing14-price03">
                  <p>
                    {props.plan2 ?? (
                      <Fragment>
                        <p className="pricing14-text095 thq-body-large">
                          Business plan
                        </p>
                      </Fragment>
                    )}
                  ...
                  <h3>
                    {props.plan2Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text094 thq-heading-3">
                          Harga Paket 2: Rp 80.000 per briket
                        </h3>
                      </Fragment>
                    )}
                  </h3>
                  <p>
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <p className="pricing14-text089 thq-body-large">
                ...
                <div className="pricing14-list1">
                  ...
                  <div className="pricing14-list-item05">
                    ...
                    <span>
                      {props.plan2Feature3 ?? (
                        <Fragment>
                          <span className="pricing14-text064 thq-body-small">
                            Menghasilkan Panas yang Tinggi
                          </span>
                        </Fragment>
                      )}
              ...
              <div className="pricing14-price04">
                <div className="pricing14-price05">
                  <p>
                    {props.plan3 ?? (
                      <Fragment>
                        <p className="pricing14-text062 thq-body-large">
                          Enterprise plan
                        </p>
                      </Fragment>
                    )}
                  ...
                  <h3>
                    {props.plan3Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text074 thq-heading-3">
                          Harga Paket 3: Rp 100.000 per briket
                        </h3>
                      </Fragment>
                    )}
                  </h3>
                  <p>
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <p className="pricing14-text068 thq-body-large">
              ...
              <div className="pricing14-price06">
                <div className="pricing14-price07">
                  <span>
                    {props.plan11 ?? (
                      <Fragment>
                        <span className="pricing14-text088 thq-body-large">
                          Basic plan
                        </span>
                      </Fragment>
                    )}
                  ...
                  <h3>
                    {props.plan1Price1 ?? (
                      <Fragment>
                        <h3 className="pricing14-text065 thq-heading-3">
                          $200/yr
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <div className="pricing14-list-item14">
                    ...
                    <span>
                      {props.plan1Feature31 ?? (
                        <Fragment>
                          <span className="pricing14-text106 thq-body-small">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
              ...
              <div className="pricing14-price08">
                <div className="pricing14-price09">
                  ...
                  <h3>
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <h3 className="pricing14-text101 thq-heading-3">
                          $299/yr
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <span>
                    {props.plan2Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text077 thq-body-large">
                          or $29 monthly
                        </span>
                      </Fragment>
                    )}
                  ...
                  <div className="pricing14-list-item17">
                    ...
                    <span>
                      {props.plan2Feature31 ?? (
                        <Fragment>
                          <span className="pricing14-text071 thq-body-small">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <h3>
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <h3 className="pricing14-text083 thq-heading-3">
                          $499/yr
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <span>
                    {props.plan3Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text091 thq-body-large">
                          or $49 monthly
                        </span>
                      </Fragment>
                    )}
                  ...
                  <div className="pricing14-list-item20">
                    ...
                    <span>
                      {props.plan3Feature21 ?? (
                        <Fragment>
                          <span className="pricing14-text060 thq-body-small">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="pricing14-list-item22">
                    ...
                    <span>
                      {props.plan3Feature41 ?? (
                        <Fragment>
                          <span className="pricing14-text075 thq-body-small">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
